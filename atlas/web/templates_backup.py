...
XSS-safe (createElement/textContent). Restore je CLI (atlas restore) dok je
...
<div class="card">
  ...
  <pre>atlas restore &lt;putanja-do-kopije&gt;.db</pre>
  <p class="muted">Trenutna baza se prije vraćanja spremi kao <code>atlas.db.prerestore</code>.</p>
</div>
