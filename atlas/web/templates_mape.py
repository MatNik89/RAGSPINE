...
async function loadBrowse(path){
  ...
  if(!d.path){
    if(!d.roots.length){ var p=document.createElement('p'); p.className='meta';
      p.textContent='Nema konfiguriranih korijena (ATLAS_MOUNT_ROOTS).'; list.appendChild(p); }
...
📌 Za <b>propise</b> dodaj <b>jednu glavnu mapu</b> (npr. <code>Propisi</code>). Unutar nje neka su podmape po vrsti — <code>Zakoni</code>, <code>Pravilnici</code>, <code>Uredbe</code>, <code>Mišljenja</code>, <code>NN</code> — ATLAS prepozna vrstu i autoritet po nazivu podmape.</p>
