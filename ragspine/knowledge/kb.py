...
def save(spine, question: str, answer: str, category: str = "", tags: str = "") -> int:
    with spine.write() as c:
        cur = c.execute(
            "INSERT INTO knowledge(question,answer,category,tags) VALUES(?,?,?,?)",
            (question, answer, category, tags),
        )
        return cur.lastrowid


def lookup(spine, question: str, threshold: float = 0.6) -> str | None:
